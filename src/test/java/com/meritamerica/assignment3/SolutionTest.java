...
public class SolutionTest {
    ...
    @Test
    public void testFailedReadFromFile2() {    	
    	boolean result = MeritBank.readFromFile("src/test/testMeritBank_bad2.txt");
    	assertEquals(true, result);
    	
    	result = MeritBank.readFromFile("src/test/testMeritBank_bad2.txt");
    	assertEquals(false, result);
